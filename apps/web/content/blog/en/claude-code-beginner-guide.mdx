...
If you see a version number `v18.0.0` or higher, you're set. If nothing appears or the version is below 18, follow the [Node.js Installation Guide](/blog/nodejs-install-vibe-coding).
