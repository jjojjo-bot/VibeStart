...
- [Git Installation Guide](https://1daymillion.com/vibe-coding-git-install-guide/)
- [Node.js Installation Guide](https://1daymillion.com/vibe-coding-nodejs-install/)
...
Node.js either isn't installed or isn't in your PATH. Follow the [Node.js Installation Guide](https://1daymillion.com/vibe-coding-nodejs-install/), then completely quit and reopen Cursor for PATH changes to take effect.
